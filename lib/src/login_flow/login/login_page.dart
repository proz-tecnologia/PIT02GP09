...
class _LoginPageState extends State<LoginPage> with ValidationMixin {
  ...
  final confPasswordController = TextEditingController(text: 'Rinex1#');
...
//Faz o controle de foco
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      // appBar: AppBar(
      //   // centerTitle: true,
      //   title: const Text(Consts.textLogin),
      // ),
      body: SafeArea(
        child: ListView(
          children: [
                              ...
                              Row(
                                ...
                                children: [
                                  TextRichInfo(
                                    ...
                                    link: () => debugPrint('Esqueceu a senha'),
                                  ),
                                ],
                              ),
                            ],
